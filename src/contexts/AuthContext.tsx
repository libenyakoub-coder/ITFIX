...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signUp = async (data: {
    ...
    try {
      // ✅ Vérification du domaine — extranet réservé aux employés IT-Fix
      if (!data.email.endsWith('@itfix.com')) {
        throw new Error("Inscription refusée. Seuls les employés IT-Fix (@itfix.com) peuvent s'inscrire.");
      }
